...
let Users = [
    ...
    new User (8, 'Ivan', 'Ivanov', 'iv@gmail.com', '+380225555'),
    new User (3,'Sveta', 'Makarova', 'sv@gmail.com', '+3806625555'),
    new User (6, 'Kolya', 'Mihel', 'mh@ukr.net', '+380848464684'),
    new User (5, 'Pasha', 'Buhyan', 'jnjn@gmail.com', '+380825484948'),
    new User (2, 'Vasya', 'Tuz', 'dsfs@gmail.com', '+380825555'),
    new User (7, 'Grisha', 'Fedorov', 'sdf@gmail.com', '+3807355265'),
    new User (4, 'olya', 'Muzika', 'onno@gmail.com', '+3808254544'),
